...
function ObtenerDirecciones(codigo, database){
    ...
    try {
        ...
        var mQuery = 'SELECT T0."Address" AS "Codigo", ' +
                    	...
                    	'	IFNULL(CASE T0."U_MSS_DVLU" WHEN 1 THEN \'Y\' ELSE \'N\' END,\'N\') AS "VisitaLunes", ' +
                    	'	IFNULL(CASE T0."U_MSS_DVMA" WHEN 1 THEN \'Y\' ELSE \'N\' END,\'N\') AS "VisitaMartes", ' +
                    	'	IFNULL(CASE T0."U_MSS_DVMI" WHEN 1 THEN \'Y\' ELSE \'N\' END,\'N\') AS "VisitaMiercoles", ' +
                    	'	IFNULL(CASE T0."U_MSS_DVJU" WHEN 1 THEN \'Y\' ELSE \'N\' END,\'N\') AS "VisitaJueves", ' +
                    	'	IFNULL(CASE T0."U_MSS_DVVI" WHEN 1 THEN \'Y\' ELSE \'N\' END,\'N\') AS "VisitaViernes", ' +
                    	'	IFNULL(CASE T0."U_MSS_DVSA" WHEN 1 THEN \'Y\' ELSE \'N\' END,\'N\') AS "VisitaSabado", ' +
                    	'	IFNULL(CASE T0."U_MSS_DVDO" WHEN 1 THEN \'Y\' ELSE \'N\' END,\'N\') AS "VisitaDomingo", ' +
	...
	{ 
	    ...
	    if(emps !== undefined){
            query = 'SELECT T0."CardCode" AS "Codigo",  ' +
                     ...
                     ' "CardCode" = T0."CardCode" AND "AdresType" = \'S\' AND "U_MSS_COVE" IN  ( '+emps+' ) ) > 0 ' + 
                     //'   AND T0."validFor" = \'Y\' '+
                     '   AND T0."frozenFor" = \'N\'';
