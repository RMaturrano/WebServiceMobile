...
try{
	...
	{ 
        ...
        var query = ' SELECT \'EstadoCuenta1\' AS "TipoReporte",  ' +
                  ...
                  '  FROM '+dbname+'.OINV T0  ' +
                    ...
                    '	INNER JOIN '+dbname+'.NNM1 T3 ON T0."Series" = T3."Series" ' +
                 ...
                 //   '   AND T0."DocSubType" <> \'DN\' ' +
                  ...
                  '  SELECT  ' +
                   ...
                   ' FROM '+dbname+'.OINV T0  ' +
                    ...
                    '	INNER JOIN '+dbname+'.NNM1 T5 ON T0."Series" = T5."Series" ' +
